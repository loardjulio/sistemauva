...
<html lang="pt-br">
    ...
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=Muli' rel='stylesheet' type='text/css'><!--css da animação-->
    ...
    <body id="page-top">
        ...
        <header class="masthead">           
            ...
            <nav  class="navbar navbar-expand-lg"  id="mainNav">               
                <div class="container">
                    <a href="/">
                        <img  src="img/logos/UVA BRANCO-SEMFUNDO.png">
                    </a>                    
                </div>
            </nav> 
        </header>
        ...
        <section>
            <center>
                <div class="container">                
                    <a>
                        <img ali src="img/emconstrucao.png">
                    </a>
                </div>
            </center>
        </section>
